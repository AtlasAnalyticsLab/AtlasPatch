...
from atlas_patch.core.config import ExtractionConfig, OutputConfig, VisualizationConfig
from atlas_patch.core.models import ExtractionResult
from atlas_patch.core.paths import build_run_root
from atlas_patch.core.wsi.iwsi import IWSI
from atlas_patch.services.interfaces import VisualizationService
from atlas_patch.utils.contours import mask_to_contours
from atlas_patch.utils.visualization import (
    visualize_contours_on_thumbnail,
    visualize_mask_on_thumbnail,
    visualize_patches_on_thumbnail,
)

logger = logging.getLogger("atlas_patch.visualization_service")
