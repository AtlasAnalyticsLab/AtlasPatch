...
from atlas_patch.core.models import Mask
from atlas_patch.core.wsi.iwsi import IWSI
from atlas_patch.services.interfaces import SegmentationService

logger = logging.getLogger("atlas_patch.segmentation_service")
